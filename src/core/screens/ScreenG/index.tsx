      ...
      >
        <Box display="flex" gap={1} flexBasis="100%">
          <animated.div style={card}>
            <Box
              sx={{
                backgroundImage: `url(${images.jawa1.src})`,
                backgroundRepeat: 'no-repeat',
                backgroundSize: 'cover',
          ...
          <animated.div style={card}>
            <Box
              sx={{
                backgroundImage: `url(${images.jawa2.src})`,
                backgroundRepeat: 'no-repeat',
                backgroundSize: 'cover',
                backgroundPosition: 'center bottom',
              }}
        ...
        <Box display="flex" flexBasis="40%">
          <animated.div style={card}>
            <Box
              sx={{
                backgroundImage: `url(${images.jawaLandscape.src})`,
                backgroundRepeat: 'no-repeat',
                backgroundSize: 'cover',
        ...
        <Box display="flex" gap={1} flexBasis="100%">
          <animated.div style={card}>
            <Box
              sx={{
                backgroundImage: `url(${images.jawa3.src})`,
                backgroundRepeat: 'no-repeat',
                backgroundSize: 'cover',
                backgroundPosition: 'center bottom',
              }}
          ...
          <animated.div style={card}>
            <Box
              sx={{
                backgroundImage: `url(${images.jawa4.src})`,
                backgroundRepeat: 'no-repeat',
                backgroundSize: 'cover',
                backgroundPosition: 'center bottom',
              }}
